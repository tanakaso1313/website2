document.addEventListener('DOMContentLoaded', () => {
    ...
    if (galleryContainer) {
        ...
        const works = [
            { src: `images/top${imageFolder}/10.uneri_top_result_result.webp`, monoSrc: `images/mono${imageFolder}/10.uneri_top_mono_result_result.webp`, href: 'uneri.html', category: 'furniture', alt: 'Uneri' },
